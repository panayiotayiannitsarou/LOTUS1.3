...
def norm_behavior(val: object) -> str:
    ...
    aliases = {
        "": "Ο", "NAN": "Ο", "NONE": "Ο",
        # ⚠️ Κρατάμε ΚΑΙ το λατινικό "O" (U+004F) ΚΑΙ το ελληνικό Όμικρον
        # "Ο" (U+039F) ως ξεχωριστά κλειδιά, γιατί μοιάζουν οπτικά αλλά
        # είναι διαφορετικοί χαρακτήρες — τα δεδομένα μπορεί να έχουν είτε
        # το ένα είτε το άλλο ανάλογα με το πρόγραμμα/πληκτρολόγιο εισαγωγής.
        "O": "Ο", "Ο": "Ο",
        "ΟΧΙ": "Ο", "NO": "Ο", "FALSE": "Ο", "0": "Ο",
        # Ίδιο ζήτημα για το "N1": λατινικό N (U+004E) vs ελληνικό Ν (U+039D)
        "N1": "Ν1", "Ν1": "Ν1",
        "N": "Ν", "Ν": "Ν", "ΝΑΙ": "Ν", "YES": "Ν", "TRUE": "Ν", "1": "Ν",
        "Y": "Ν", "Τ": "Ν", "ΑΙΣ": "Ν", "NAI": "Ν",
    }
    if s not in aliases:
        raise ValueError(
